...
def save_cur_trainval_plot(
    ...
    train_acc_str = (
        "Best training "
        + acc_name
        + ": {:.2f} at epoch {:d}".format(best_train_acc, best_train_acc_ep)
    )
    val_acc_str = (
        "Best validation "
        + acc_name
        + ": {:.2f} at epoch {:d}".format(best_val_acc, best_val_acc_ep)
    )
    train_loss_str = (
        "Best training "
        + loss_name
        + ": {:.4f} at epoch {:d}".format(best_train_loss, best_train_loss_ep)
    )
    val_loss_str = (
        "Best validation "
        + loss_name
        + ": {:.4f} at epoch {:d}".format(best_val_loss, best_val_loss_ep)
    )
